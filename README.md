...
Проект автоматизации UI-тестирования на **Python + Selenium + pytest** с полным CI/CD-пайплайном в **Jenkins**, запуском браузера в **Docker** и публикацией HTML-отчётов[^1].

[^1]: в будущем обновление`
---
